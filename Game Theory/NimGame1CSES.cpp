...
// Note: The code is designed to handle multiple test cases as per the CSES problem format.
// The nim game is solved by calculating the nim sum of the piles.
// If the nim sum is zero, the second player has a winning strategy; otherwise, the first player does.
