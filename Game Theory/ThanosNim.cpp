...
/*
                                                                Thanos Nim                  
Alice and Bob are playing a game with n
 piles of stones. It is guaranteed that n
...
On a player's turn, they must choose exactly n2
 nonempty piles and independently remove a positive number of stones from each of the chosen piles. They can remove a different number of stones from the piles in a single turn. The first player unable to make a move loses (when there are less than n2
 nonempty piles).
...
The first line contains one integer n
 (2≤n≤50
) — the number of piles. It is guaranteed that n
 is an even number.
